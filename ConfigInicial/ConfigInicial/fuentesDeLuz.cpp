...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].diffuse"), 2.9f, 2.9f, 2.9f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].specular"), 3.9f, 3.9f, 7.9f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].specular"), 0.3f, 0.3f, 0.3f);
        ...
        view = camera.GetViewMatrix();	
		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 5, GL_FALSE, glm::value_ptr(model));
